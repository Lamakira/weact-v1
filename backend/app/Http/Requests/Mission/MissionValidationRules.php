...
trait MissionValidationRules
{
    ...
    protected function missionRules(): array
    {
        return [
            ...
            'budget' => ['required', 'integer', 'min:1', 'max:4294967295'],
            'date_limite_candidature' => ['required', 'date', 'after:today'],
            'nombre_faces_voulu' => ['nullable', 'integer', 'min:1', 'max:65535'],
    ...
    protected function missionMessages(): array
    {
        return [
            ...
            'budget.max' => 'Le budget ne peut pas dépasser :max.',
            ...
            'nombre_faces_voulu.max' => 'Le nombre de Faces ne peut pas dépasser :max.',
