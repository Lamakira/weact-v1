...
@section('title', 'Mission terminée — Portefeuille crédité')
...
@section('content')
    ...
    <p style="margin: 0 0 20px; color: #374151; font-size: 15px; line-height: 1.6;">
        La mission <strong>«&nbsp;{{ $missionTitle }}&nbsp;»</strong> est terminée.
        Votre portefeuille a été crédité de <strong>{{ $formattedAmount }}</strong>.
    </p>

    {{-- Mission completion details card --}}
    <table width="100%" cellpadding="0" cellspacing="0" style="background-color: #f9fafb; border-radius: 6px; margin: 0 0 24px;">
        <tr>
            <td style="padding: 16px 20px;">
                <table width="100%" cellpadding="0" cellspacing="0">
                    <tr>
                        <td style="padding: 0 0 10px; color: #6b7280; font-size: 13px;">Mission terminée</td>
                        <td style="padding: 0 0 10px; color: #111827; font-size: 14px; font-weight: 600; text-align: right;">{{ $missionTitle }}</td>
                    </tr>
                    <tr>
                        <td style="padding: 0; color: #6b7280; font-size: 13px;">Montant crédité</td>
    ...
    <p style="margin: 0; padding: 12px 16px; background-color: #d1fae5; border-radius: 6px; color: #065f46; font-size: 13px; line-height: 1.5;">
        ✅ Vos fonds sont disponibles et peuvent être retirés dès maintenant via votre portefeuille.
    </p>
@endsection
