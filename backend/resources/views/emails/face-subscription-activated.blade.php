...
@section('title', 'Abonnement Premium activé')
...
@section('content')
    ...
    <p style="margin: 0 0 20px; color: #374151; font-size: 15px; line-height: 1.6;">
        Votre abonnement <strong>Premium annuel</strong> est activé. Vos <strong>photos 3-4</strong> et votre <strong>vidéo de jeu</strong> sont maintenant visibles publiquement sur votre profil.
    </p>
            ...
            <td style="padding: 16px 20px;">
                <table width="100%" cellpadding="0" cellspacing="0">
                    <tr>
                        ...
                        <td style="padding: 0 0 10px; color: #111827; font-size: 14px; font-weight: 600; text-align: right;">Premium annuel</td>
                    </tr>
                    <tr>
