...
@section('content')
    ...
    <p style="margin: 0 0 20px; color: #374151; font-size: 15px; line-height: 1.6;">
        <strong>{{ $faceName }}</strong> a accepté votre booking. Il ne reste qu'à régler le paiement
        pour confirmer définitivement la prestation.
    </p>

    {{-- Récapitulatif du booking --}}
        ...
        <tr>
            <td style="padding: 16px 20px;">
                <table width="100%" cellpadding="0" cellspacing="0">
                    ...
                    @endif
                    <tr>
                        <td style="padding: 0; color: #6b7280; font-size: 13px;">Montant à régler</td>
    ...
    <p style="margin: 0; padding: 12px 16px; background-color: #fef3c7; border-radius: 6px; color: #92400e; font-size: 13px; line-height: 1.5;">
        @if($paymentDeadline)
            Vous avez jusqu'au {{ $paymentDeadline }}, soit 24 heures après l'acceptation, pour régler ce booking.
        @else
            Vous disposez de 24 heures après l'acceptation pour régler ce booking.
        @endif
        Sans paiement passé ce délai, le booking expire automatiquement et la Face redevient disponible.
    </p>
@endsection
