...
class ProducerRateFaceTest extends TestCase
{
    use RefreshDatabase;
    ...
    // ========================================================================
    // AC #1: Producer can rate Face after completed candidature
    // ========================================================================
    ...
    // ========================================================================
    // AC #6: Rating another Producer's mission candidature returns 403
    // ========================================================================

    public function test_rating_another_producer_mission_candidature_returns_403(): void
    {
        ...
        // Create candidature for another producer's mission
    ...
    public function test_comment_html_tags_are_stripped(): void
    {
        ...
        $response->assertStatus(201);
        $this->assertEquals('alert("xss")Great talent!', $response->json('data.comment'));

        $this->assertDatabaseHas('ratings', [
            'candidature_id' => $this->completedCandidature->id,
            'comment' => 'alert("xss")Great talent!',
        ]);
    }
    ...
    public function test_rating_response_includes_rater_and_rated_info(): void
    {
        ...
        // Verify rater is the Producer user
