...
import { LayoutDashboard, FileText, ShieldCheck, Briefcase, CalendarCheck, UserCheck, Building, TrendingUp, Scale, MessageCircle, Ban, CreditCard } from 'lucide-vue-next'
