  ...
  <div class="min-h-screen bg-background pb-20">
    ...
    <header class="sticky top-0 z-20 border-b border-border bg-background/80 backdrop-blur-md">
      <div class="container mx-auto flex h-20 items-center justify-between px-4 sm:px-6">
        ...
        <button
          type="button"
          class="relative lg:hidden inline-flex items-center gap-2 rounded-lg border border-border bg-card px-4 py-2 text-sm font-medium transition-colors hover:bg-muted"
    ...
    <main class="container mx-auto mt-8 px-4 sm:px-6">
      <div class="flex flex-col lg:flex-row gap-6">
        ...
        <div class="flex-1 min-w-0">
          <!-- Loading State -->
          <div v-if="isLoading && !missions.length" class="grid gap-6 sm:grid-cols-2 xl:grid-cols-3">
            <div
              v-for="i in 6"
              :key="i"
