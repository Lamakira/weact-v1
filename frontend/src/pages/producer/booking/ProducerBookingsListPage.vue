  ...
  <div>
    ...
    <div class="mb-8">
      ...
      <p class="mt-1 text-slate-500">
        Gérez vos demandes de booking envoyées aux Faces
      </p>
    </div>
    ...
    <div>
      ...
      >
        ...
        <p class="mt-2 max-w-xs text-muted-foreground">
          ...
          <template v-else>
            Vous n'avez pas encore envoyé de demande de booking.<br />
            Parcourez les Faces pour trouver votre talent !
          </template>
        </p>
        <button
          v-if="!statusFilter"
