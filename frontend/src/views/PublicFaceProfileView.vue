...
const displayProfile = computed((): CandidateFullProfile | null => {
  ...
  if (face.value) {
    ...
    return {
      ...
      username: f.username,
      sexe: fa.sexe ?? null,
      sexe_label: fa.sexe_label ?? null,
      age: fa.age ?? null,
      nationalite: fa.nationalite ?? null,
      langues: fa.langues ?? [],
      taille: fa.taille ?? null,
      poids: null,
      bio: fa.bio ?? null,
      ville: f.ville,
      pays: fa.pays ?? null,
      ...
      thumbnail_url: null,
      presentation_video_url: fa.presentation_video_url ?? null,
      presentation_video_thumbnail_url: fa.presentation_video_thumbnail_url ?? null,
      acting_video_url: fa.acting_video_url ?? null,
      acting_video_thumbnail_url: fa.acting_video_thumbnail_url ?? null,
      tarif_horaire: null,
      ...
      >
        <div class="lg:grid lg:grid-cols-[35%_1fr] lg:gap-12 xl:gap-16 items-start">
          ...
          <aside class="reveal-left mb-8 lg:mb-0 lg:sticky lg:top-8">
            <ProfilePhotoSection
              :photo-url="face.profile_photo_large_url || face.profile_photo_medium_url || face.profile_photo_url"
              :original-photo-url="face.profile_photo_url"
              :prenom="face.prenom"
