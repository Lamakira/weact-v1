...
describe('useNotificationStore', () => {
  ...
  describe('fetchNotifications', () => {
    it('calls API, updates items, and sets hasFetchedItems', async () => {
  ...
  describe('markAsRead', () => {
    it('optimistically updates local state then calls API', async () => {
  ...
  describe('markAllAsRead', () => {
    it('optimistically updates all items then calls API', async () => {
      const notifications = [
