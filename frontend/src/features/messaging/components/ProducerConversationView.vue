...
const handleBack = () => {
  // Use browser history to return to previous page (candidatures list, mission detail, etc.)
  // Fallback to missions list if no history available
