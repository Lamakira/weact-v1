...
<template>
  <div class="producer-profile-photo-upload" data-testid="producer-profile-photo-upload">
    <!-- Error message -->
    <div
      v-if="error"
    ...
    <div class="flex flex-col items-center gap-4">
      ...
      <div class="flex gap-3">
        ...
        <button
          ...
          class="px-4 py-2 text-sm font-medium text-white bg-weact-600 rounded-lg hover:bg-weact-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-weact-500 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
