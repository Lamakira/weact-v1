...
<template>
  <div class="bg-white">
    ...
    <!-- Hero                                                          -->
    <!-- ============================================================ -->
    <section class="max-w-3xl mx-auto px-6 pt-16 pb-12 text-center sm:pt-20 lg:pt-24">
      <div class="text-xs font-semibold text-[#198496] uppercase tracking-[0.14em] mb-4">
        Abonnements Faces · Tarifs 2026
      </div>
      <h1
      ...
      >
        <div
          ...
          :class="[
            ...
            tier.key === 'elite' ? 'bg-[#0F1419] text-white' : 'bg-white',
    ...
    <section class="bg-[#FAFAFA] py-20">
      <div class="max-w-7xl mx-auto px-6">
        ...
        <div
          class="border border-gray-200 rounded-2xl overflow-hidden bg-white overflow-x-auto"
        >
    ...
    <section class="max-w-3xl mx-auto px-6 py-20">
      ...
      <div class="flex flex-col gap-2.5">
        <div
          ...
          :key="index"
          class="border border-gray-200 rounded-lg bg-white overflow-hidden transition-all"
        >
          <button
    ...
    <!-- Footer CTA                                                    -->
    <!-- ============================================================ -->
    <section class="bg-[#FAFAFA] pb-20">
      <div class="max-w-3xl mx-auto px-6">
        <div
          class="bg-white border border-gray-200 rounded-2xl p-10 text-center shadow-sm"
        >
